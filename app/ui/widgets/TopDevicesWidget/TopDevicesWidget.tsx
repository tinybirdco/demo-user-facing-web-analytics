          ...
          <div className="justify-self-end">
            <div className="grid grid-cols-2 gap-y-1 gap-4">
              ...
              {(data?.data ?? []).map(({ device, visits }, index) => (
                <Fragment key={device}>
                  <div className="flex items-center gap-2 text-sm leading-5 text-gray-500 h-9 px-4 py-2 rounded-md z-10">
                    <div
                  ...
                  <div className="flex items-center justify-end text-gray-500 h-9">
                    {formatNumber(visits)}
                  </div>
                </Fragment>
              ))}
